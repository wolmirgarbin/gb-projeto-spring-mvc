...
public class MailSendServiceImpl extends AbstractMail implements MailSendService {
    ...
    private void sendMail(final String[] para, final String de, final String resposta, final String titulo, final String conteudo, final String arquivo, final Documentos[] documentos) {
        try {
    ...
    @Override
	public void sendMail(String[] para, String de, String titulo, String conteudo) {
    	sendMail(para, de, ConfigureApp.getInstance().getEmailPadrao(), titulo, getHtmlPadrao(titulo, conteudo), null, null);
    }
    
    
    @Override
    public void enviarDocumentos(final String[] para, final String de, final String titulo, final String conteudo, final Documentos[] documentos) {
    	sendMail(para, de, ConfigureApp.getInstance().getEmailPadrao(), titulo, getHtmlPadrao(titulo, conteudo), null, documentos);
    }
}

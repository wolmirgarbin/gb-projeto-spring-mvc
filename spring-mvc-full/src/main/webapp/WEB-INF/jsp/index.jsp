...
<div class="topo-site">
	<div class="top-sup-container">
		<div class="container">
			...
			<div class="top-sup-login radius-2 shadow">
				<span>DF-e</span>
				<b>Portal de Documentos Fiscais Eletrônicos</b>
			</div>
		</div>
	</div>
	...
	<div class="top-inf-container bt shadow">
		<div class="container clearfix">
			<div class="logo-agro">
				<a href="${ applicationProperties.urlAgro }"><img alt="Agrosoft" src="${ applicationPath }resources/img/logo/agronegocios.png"></a>
			</div>

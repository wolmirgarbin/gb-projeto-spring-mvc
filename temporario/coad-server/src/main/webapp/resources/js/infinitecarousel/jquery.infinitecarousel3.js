	...
	$.fn.extend({ 
		infiniteCarousel: function(options)
		{
			...
			var options = $.extend(defaults, options);
				...
				$(obj).append('<div class="ic_left_nav" style="position:absolute;left:0;width:50px;top:'+(heightSource/2-20)+'px;">').append('<div class="ic_right_nav" style="position:absolute;width:50px;right:0;top:'+(heightSource/2-20)+'px;">');
				...
				if( o.autoStart ){
					...
					$('.ic_left_nav',obj).stop().animate({opacity:0,left:'-32px'},800);
					$('.ic_right_nav',obj).stop().animate({opacity:0,right:'-32px'},800);
				}
 			});
		}
	});

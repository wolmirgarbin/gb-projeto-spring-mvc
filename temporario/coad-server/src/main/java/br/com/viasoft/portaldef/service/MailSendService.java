...
public interface MailSendService {
     ...
     */
    void sendMailSenha(final String[] para, final String de, final String titulo, final String conteudo);
     ...
     * @throws ServiceException retorna erro caso algum dos parametros seja nulo ou ocorra algum erro ao enviar o e-mail
     */
    void sendRelatorioCotaMensal(final String[] para, final String de, final String titulo, final String conteudo);
     ...
     * @param documentos
     */
    void enviarDocumentos(final String[] para, final String[] cc, final String de, final String titulo, final String conteudo, final Documentos[] documentos);

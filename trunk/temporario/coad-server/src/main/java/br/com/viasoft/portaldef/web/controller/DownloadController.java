...
public class DownloadController extends BaseController {
	...
	public String download(Model model, @PathVariable("id") Long id, HttpServletResponse response, HttpServletRequest request) {
		...
		if( Roles.ROLE_CLIENTE.equals( usuarioService.getUsuario().getRole() ) ) {
			...
			final String identificacao = usuarioService.getUsuario().getEmpresaBase() != null ? usuarioService.getUsuario().getEmpresaBase().getIdentificacao() : usuarioService.getUsuario().getPessoa().getIdentificacao();
			if( ! dfeService.permiteDownload( identificacao, id) ){

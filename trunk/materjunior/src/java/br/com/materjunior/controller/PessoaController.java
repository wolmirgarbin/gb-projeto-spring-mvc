...
public class PessoaController implements Serializable {
    ...
    private PessoaJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new PessoaJpaController(Persistence.createEntityManagerFactory("materjuniorPU"));
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getPessoaCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findPessoaEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getPessoaCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findPessoaEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findPessoaEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findPessoaEntities(), true);
    }
